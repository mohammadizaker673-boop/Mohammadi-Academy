  ...
  const navStructure = [
    ...
    { path: '/admin/analytics', icon: BarChart3, label: 'Analytics', exact: false },
    {
      ...
      children: [
        ...
        { path: '/admin/courses/quran-translation', label: 'Quran Translation Course' },
        { path: '/admin/courses/islamic-studies', label: 'Islamic Studies Course' },
        { path: '/admin/courses/access', label: 'Premium Course Access' },
      ]
    },
    {
      id: 'students',

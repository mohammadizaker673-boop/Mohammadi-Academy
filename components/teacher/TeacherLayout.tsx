...
const TeacherLayout: React.FC = () => {
  ...
  const navItems = [
    { path: '/teacher', icon: LayoutDashboard, label: t.dashboard.teacher.dashboard, exact: true },
    { path: '/teacher/students', icon: Users, label: t.dashboard.teacher.myStudents },
    { path: '/teacher/attendance', icon: Calendar, label: t.dashboard.teacher.attendance },
    { path: '/teacher/lessons', icon: BookOpen, label: t.dashboard.teacher.lessons },
    { path: '/teacher/announcements', icon: Bell, label: t.dashboard.teacher.announcements },
  ];
    ...
    <div className="min-h-screen bg-[#050a12]">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-white truncate">{user?.displayName || 'Teacher'}</p>
            ...
            return (
              ...
              >
                <div className="relative">
                  <Icon size={20} />
                  {item.label === t.dashboard.teacher.announcements && unreadCount > 0 && (
                ...
                {sidebarOpen && item.label === t.dashboard.teacher.announcements && unreadCount > 0 && (
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10 space-y-2">
          ...
          >
            <LogOut size={20} />
            {sidebarOpen && <span className="text-sm font-bold">{t.dashboard.teacher.logout}</span>}
          </button>
        </div>
      </aside>
